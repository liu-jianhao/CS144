...
tests/CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.o: ../tests/wrapping_integers_cmp.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/sf_share/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.o"
	cd /media/sf_share/sponge/build/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.o -c /media/sf_share/sponge/tests/wrapping_integers_cmp.cc
...
tests/CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.i: cmake_force
	...
	cd /media/sf_share/sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/sf_share/sponge/tests/wrapping_integers_cmp.cc > CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.i
...
tests/CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.s: cmake_force
	...
	cd /media/sf_share/sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/sf_share/sponge/tests/wrapping_integers_cmp.cc -o CMakeFiles/wrapping_integers_cmp.dir/wrapping_integers_cmp.cc.s
...
tests/wrapping_integers_cmp: tests/CMakeFiles/wrapping_integers_cmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/sf_share/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable wrapping_integers_cmp"
	cd /media/sf_share/sponge/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/wrapping_integers_cmp.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/wrapping_integers_cmp.dir/clean:
	cd /media/sf_share/sponge/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/wrapping_integers_cmp.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/wrapping_integers_cmp.dir/clean

tests/CMakeFiles/wrapping_integers_cmp.dir/depend:
	cd /media/sf_share/sponge/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /media/sf_share/sponge /media/sf_share/sponge/tests /media/sf_share/sponge/build /media/sf_share/sponge/build/tests /media/sf_share/sponge/build/tests/CMakeFiles/wrapping_integers_cmp.dir/DependInfo.cmake --color=$(COLOR)
